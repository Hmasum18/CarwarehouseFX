...
public class IntentFX {
    ...
    public IntentFX(Stage stage, String fxmlLocationFromSrc) {
        this.stage = stage;
        this.newFXML = fxmlLocationFromSrc;
    }

    public IntentFX(Scene scene, String fxmlLocationFromSrc) {
        this.stage = (Stage) scene.getWindow();
        this.newFXML = fxmlLocationFromSrc;
    }

    public IntentFX(Node node, String fxmlLocationFromSrc) {
        this.stage = (Stage) node.getScene().getWindow();
        this.newFXML = fxmlLocationFromSrc;
    }

    public IntentFX(Node node, String fxmlLocationFromSrc, int animation) {
        this.stage = (Stage) node.getScene().getWindow();
        this.newFXML = fxmlLocationFromSrc;
